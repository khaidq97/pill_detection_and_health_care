...
class TextRecognizer():
    def __init__(self, model_name='vgg_seq2seq', device='cpu', have_beamsearch=False, cnn_pretrained=False):
    ...
    def run_ocr(self, image_path, bboxes, debug=False, debug_dir=""):
        ...
        for text_box in bboxes:
            x1, y1, x2, y2 = text_box['x1'], text_box['y1'], text_box['x2'], text_box['y2']
